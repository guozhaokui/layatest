...
(function(window,document,Laya){
	...
	*/
	...
	var Shader3D=(function(){
		...
		Shader3D.__init__=function(){
			...
			vs="attribute vec4 a_Position;\nattribute vec2 a_Texcoord0;\nattribute float a_Time;\n\nuniform mat4 u_MvpMatrix;\nuniform  float u_CurrentTime;\nuniform  vec4 u_Color;\nuniform float u_Duration;\n\nvarying vec2 v_Texcoord;\nvarying vec4 v_Color;\n\n\nvoid main()\n{\n  gl_Position = u_MvpMatrix * a_Position;\n  \n  float age = u_CurrentTime-a_Time;\n  float normalizedAge = clamp(age / u_Duration,0.0,1.0);\n   \n  v_Texcoord=a_Texcoord0;\n  \n  v_Color=u_Color;\n  v_Color.a*=1.0-normalizedAge;\n}\n"/*__INCLUDESTR__f:/work/layaairpublish/src/d3/src/laya/d3/shader/files/glitter.vs*/;
			ps="#ifdef FSHIGHPRECISION\nprecision highp float;\n#else\nprecision mediump float;\n#endif\n\nuniform vec4 u_Albedo;\nuniform sampler2D u_Texture;\n\nvarying vec2 v_Texcoord;\nvarying vec4 v_Color;\n\n\nvoid main()\n{	\n  gl_FragColor=texture2D(u_Texture, v_Texcoord)*v_Color;\n  gl_FragColor=gl_FragColor*u_Albedo;\n}\n\n"/*__INCLUDESTR__f:/work/layaairpublish/src/d3/src/laya/d3/shader/files/glitter.ps*/;
			...
			vs="attribute vec4 a_Position;\nuniform mat4 u_MvpMatrix;\nvarying vec3 v_Texcoord;\n\n\nvoid main()\n{\n  gl_Position = (u_MvpMatrix*a_Position).xyww;\n  v_Texcoord=a_Position.xyz;\n}\n"/*__INCLUDESTR__f:/work/layaairpublish/src/d3/src/laya/d3/shader/files/skybox.vs*/;
			ps="#ifdef FSHIGHPRECISION\nprecision highp float;\n#else\nprecision mediump float;\n#endif\n\nuniform float u_Intensity;\nuniform float u_AlphaBlending;\nuniform samplerCube u_CubeTexture;\n\nvarying vec3 v_Texcoord;\n\n\nvoid main()\n{	\n  gl_FragColor=vec4(textureCube(u_CubeTexture, v_Texcoord).rgb*u_Intensity,u_AlphaBlending);\n}\n\n"/*__INCLUDESTR__f:/work/layaairpublish/src/d3/src/laya/d3/shader/files/skybox.ps*/;
	...
	*/
	...
	/**
	*<code>Cylinder</code> 类用于创建圆柱。
	*/
	//class laya.d3.resource.models.Cylinder extends laya.d3.resource.models.PrimitiveMesh
	var Cylinder=(function(_super){
		function Cylinder(radius,height,stacks,slices){
			this._radius=NaN;
			this._height=NaN;
			this._slices=0;
			this._stacks=0;
		...
		__class(Cylinder,'laya.d3.resource.models.Cylinder',_super);
		var __proto=Cylinder.prototype;
		__proto.recreateResource=function(){
			this.startCreate();
